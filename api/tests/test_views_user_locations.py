...
class GetAllLocationsUserTest(TestCase):
    ...
    def setUp(self):
        ...
        Location.objects.create(
            position_x=3, position_y=5, description="desc1")
        Location.objects.create(
            position_x=6, position_y=7,description="desc2")
...
class GetSingleLocationUserTest(TestCase):
    ...
    def test_get_valid_single_location(self):
        ...
        response = self.client.get(
            reverse('user_locations_zpk', kwargs={'pk': self.loc1.pk}))
    ...
    def test_get_invalid_single_location(self):
        self.client.login(username='user1', password='password')
        response =  self.client.get(
            reverse('user_locations_zpk', kwargs={'pk': 30}))
